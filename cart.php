        ...
        <div class="row">
            <div class="col-8">
                <div class="card border-0">
                   ...
                   $callingOrderItem = calling("order_item JOIN products ON order_item.product_id = products.id where user_id='$user_id' AND order_id='$order_id' AND ordered='0'");
                   ...
                   ?>
                    <div class="row shadow mb-3">
                        <div class="col-3 ">  
                            <img src="productimages/<?= $value['image'];?>" alt="" class="w-100 ms-3 mt-1 " style="height: 130px;">
                        </div>
                        <div class="col-9">
                            <div class="card-body ">
                                <h4><?= $value['title'];?></h4>
                                <h5>₹<?= $value['discount_price'] * $value['qty'];?>/- 
                                <del class="text-danger">₹<?= $value['price'] * $value['qty'];?>/-</del>
                            </h5>
                                ...
                                <a href="cart.php?remove_id=<?= $value['id'];?>" class="btn btn-dark float-end"><i class="bi bi-trash"></i> Remove</a><hr class="bg-dark">
                            </div>
                        </div>
                    </div>
                    <?php } ?>
            ...
            <div class="col-4">
                <ul class="list-group">
                    ...
                    <?php if($callingOrder['coupon_id'] != 0){?>
                        <li class="list-group-item bg-warning">Coupon Discount: <span class="float-end">₹<?= $coupon_amount;?>/-</span></li>
                    <?php } ?>
                        ...
                        <div class="card-body">
                            ...
                            if(isset($_POST['apply_coupon'])){
                                    ...
                                    if($count > 0){
                                            ...
                                            $coupon_id = $row[0];
                                            $updateOrder = mysqli_query($connect,"update orders SET coupon_id='$coupon_id' WHERE user_id='$user_id' AND ordered='0'");
                                            redirect("cart.php");
                                    }
                                    else{   
