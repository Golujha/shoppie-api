...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
         ...
         <ul class="navbar-nav">
             <li  class="nav-item"><a href="index.php" class="nav-link text-info"><b>Home</b></a></li>

             <?php if(isset($_SESSION['user'])){ ?>
                <li  class="nav-item"><a href="auth/logout.php" class="nav-link text-info"><b>Logout</b></a></li>
            ...
            <?php } ?>
             ...
             <li  class="nav-item"> <a href='cart.php' class="btn btn-primary btn-sm mt-1 position-relative">
